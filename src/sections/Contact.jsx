...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    // Show success message (would be implemented)
  };
          ...
          <div className="grid md:grid-cols-5 gap-8 max-w-6xl mx-auto">
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 mt-1">123 Coding Street, Tech Valley, CA 94025</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 mt-1">contact@tezcode.tech</p>
                  </div>
                </div>
            ...
            <div className="md:col-span-3 bg-white rounded-2xl shadow-lg p-8 border border-indigo-100">
              ...
              <form onSubmit={handleSubmit}>
                ...
                <button
                  type="submit"
                  className="w-full md:w-auto px-8 py-3 bg-blue-600 text-white rounded-lg font-medium hover:bg-blue-700 transition-colors duration-300 shadow-md"
                >
                  Send Message
                </button>
              </form>
