    ...
    <footer className="relative bg-gray-900 text-gray-200">
      ...
      <div className="container relative">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 py-16">
          {/* Company Info */}
          <div>
            <h3 className="text-2xl font-bold text-white mb-4">TezCode</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="features" smooth={true} className="text-gray-400 hover:text-white transition-colors cursor-pointer">
                  Features
                </Link>
              </li>
              <li>
                <Link to="courses" smooth={true} className="text-gray-400 hover:text-white transition-colors cursor-pointer">
                  Courses
                </Link>
              </li>
              <li>
                <Link to="curriculum" smooth={true} className="text-gray-400 hover:text-white transition-colors cursor-pointer">
                  Curriculum
                </Link>
              </li>
              <li>
                <Link to="pricing" smooth={true} className="text-gray-400 hover:text-white transition-colors cursor-pointer">
                  Pricing
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-start space-x-3">
                ...
                <span className="text-gray-400">123 Coding Street, Tech Valley, CA 94025</span>
              </li>
              <li className="flex items-center space-x-3">
                <svg className="w-6 h-6 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <span className="text-gray-400">contact@tezcode.tech</span>
              </li>
              <li className="flex items-center space-x-3">
                <svg className="w-6 h-6 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
