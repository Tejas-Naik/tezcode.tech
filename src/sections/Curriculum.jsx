...
const Curriculum = () => {
  ...
  const activeCurriculum = activeTrack === "python" ? pythonCurriculum : webDevCurriculum;
      ...
      <Element name="curriculum">
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Industry-Focused Curriculum</h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Our curriculum is constantly updated with the <span className="text-blue-600 font-medium">latest technologies and practices</span> to ensure you're job-ready from day one
            </p>
          </div>
                  ...
                  <div key={index} className="relative">
                    ...
                    <div className="ml-16 p-6 rounded-xl border border-gray-200 bg-white hover:border-blue-500 hover:shadow-lg transition-all duration-300">
                      ...
                      <div className="flex flex-wrap justify-between items-start gap-2 mb-2">
                        <div>
                          <div className="text-blue-600 font-medium text-sm">{module.week}</div>
