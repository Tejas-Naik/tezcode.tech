...
const Faq = () => {
  ...
  const filteredFaqs = searchQuery
    ...
    : activeCategory === -1
      ? faq
      : faq.filter((_, index) =>
          faqCategories[activeCategory].items.includes(index)
        );
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Find answers to common questions about our bootcamp programs and
                learning experience.
              </p>
            </div>
                ...
                return (
                  ...
                  >
                    ...
                    >
                      ...
                      <div
                        className={`p-2 rounded-full transition-colors duration-300 ${openFaqs[faqIndex] ? "bg-indigo-100 text-indigo-600" : "bg-gray-100 text-gray-500"}`}
                      >
                        <svg
            ...
            <div className="mt-16 bg-gradient-to-r from-blue-600 to-indigo-600 rounded-2xl p-8 text-center text-white shadow-lg">
              ...
              <p className="text-white/90 mb-6 max-w-md mx-auto">
                Our team is ready to answer any specific questions you may have
                about our bootcamp programs.
              </p>
